...
namespace StockManagement.Application.Controllers
{
    ...
    public class MouvementStocksController : ControllerBase
    {
        ...
        public MouvementStocksController(MouvementStockService service)
        {
            _service = service;
        }
        ...
        [HttpPost]
        public IActionResult Create([FromBody] MouvementStock entity)
        {
        ...
        [HttpPut("{id}")]
        public IActionResult Update(int id, [FromBody] MouvementStock entity)
        {
